...
MeteoriteHub.Init = function(hubName: string, showGameTitle: boolean)
	...
	local function loadMenu()
		...
		MeteoriteHub.InterfaceElements["Menu"]["Dragger"] = newInstance("TextButton", {Name = "Dragger"; Parent = MeteoriteHub.InterfaceElements["Menu"]["Frame"]; Position = UDim2.fromScale(0, 0); AnchorPoint = Vector2.new(0, 0); Size = UDim2.fromOffset(410, 29); Transparency = 1; ZIndex = 2})
		...
		local gameTitle = function()
			if showGameTitle then
				return ` | <i><font transparency="0.2">{MarketplaceService:GetProductInfo(game.PlaceId).Name}</font></i>`
			else
				return ``
			end
		end
		MeteoriteHub.InterfaceElements["Menu"]["Title"] = newInstance("TextLabel", {Name = "Title"; Parent = MeteoriteHub.InterfaceElements["Menu"]["TopbarBackground"]; Text = `<b>{hubName or "Meteorite Hub"}</b>`..gameTitle(); TextXAlignment = Enum.TextXAlignment.Left; Position = UDim2.new(0, 36, 0.5, 0); AnchorPoint = Vector2.new(0, 0.5); TextColor3 = Color3.new(1, 1, 1); BackgroundTransparency = 1; RichText = true; TextSize = 9})
		...
		local function mayDrag(Frame: Frame, Parent: Frame)
			Parent = Parent or MeteoriteHub.InterfaceElements["Menu"]["Frame"]
		...
		mayDrag(MeteoriteHub.InterfaceElements["Menu"]["Dragger"], MeteoriteHub.InterfaceElements["Menu"]["Frame"])
