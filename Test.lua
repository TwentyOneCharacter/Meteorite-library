...
MeteoriteHub.Init = function()
	...
	local function loadMenu()
		...
		MeteoriteHub.InterfaceElements["Menu"]["Dragger"] = newInstance("TextButton", {Name = "Dragger"; Parent = MeteoriteHub.InterfaceElements["Menu"]["Frame"]; Position = UDim2.fromScale(0, 0); AnchorPoint = Vector2.new(0, 0); Size = UDim2.fromScale(410, 29); Transparency = 1; ZIndex = 2})
